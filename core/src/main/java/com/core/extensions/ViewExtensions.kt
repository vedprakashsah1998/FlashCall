 ...
 */
inline fun View.showSnackbar(@StringRes messageRes: Int, length: Int = Snackbar.LENGTH_LONG, f: Snackbar.() -> Unit) {
    showSnackbar(resources.getString(messageRes), length, f)
}

inline fun View.showSnackbar(message: String, length: Int = Snackbar.LENGTH_LONG, f: Snackbar.() -> Unit) {
